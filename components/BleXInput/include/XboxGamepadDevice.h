...
static const char* dPadDirectionName(uint8_t direction){
...
public:
    XboxGamepadDevice();
    XboxGamepadDevice(XboxSeriesXControllerDeviceConfiguration* config);
    ~XboxGamepadDevice();

    void init(NimBLEHIDDevice* hid);
    const XboxSeriesXControllerDeviceConfiguration* getDeviceConfig() const;
...
private:
    ...
    XboxSeriesXControllerDeviceConfiguration* _config;
